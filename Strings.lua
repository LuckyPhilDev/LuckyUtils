...
LuckyUtilsStrings = LuckyStrings.New("LuckyUtilsStrings", {
    ...
    bankRun = {
        ...
        mode         = "Warbank Stocking Mode",
        modeDesc     = "Auto moves your items as soon as you open the bank. Manual opens the Bank Queue with a Start button, and nothing moves until you press it. Applies to every character and every Lucky addon that moves items at the bank.",
        modeAuto     = "Auto",
        modeManual   = "Manual",
